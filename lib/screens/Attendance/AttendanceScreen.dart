...
import 'package:open_core_hr/screens/Visits/visit_screen.dart';
    ...
    final AlertDialog setPinDialog = AlertDialog(
      ...
      actions: [
        TextButton(
          ...
          onPressed: () {
            if (isAndroid) {
              OpenSettingsPlusAndroid android = OpenSettingsPlusAndroid();
              android.search();
            } else if (isIOS) {
              OpenSettingsPlusIOS ios = OpenSettingsPlusIOS();
        ...
        TextButton(
          child: Text(
            language.lblOk,
            style: primaryTextStyle(color: appStore.appColorPrimary),
          ),
          onPressed: () {
            finish(context);
          },
