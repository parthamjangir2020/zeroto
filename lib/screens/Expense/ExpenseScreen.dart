    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Observer(
            builder: (_) {
              return (_store.selectedStatus != null || _store.dateFilter != '')
                  ? Padding(
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              child: PagedListView<int, ExpenseRequestModel>(
                ...
                builderDelegate: PagedChildBuilderDelegate<ExpenseRequestModel>(
                    ...
                    return ExpenseItemWidget(
                      ...
                      deleteAction: (BuildContext context) {
                        showConfirmDialogCustom(
                          context,
                          title:
                              'Are you sure you want to cancel this expense request?',
                          dialogType: DialogType.CONFIRMATION,
                          positiveText: language.lblYes,
                          negativeText: language.lblNo,
                          onAccept: (c) async {
                            await _store.cancelExpense(expenseRequest.id!);
                            _store.pagingController.refresh();
                          },
                        );
                      },
